...
const string strMessageMagic = "NOMOICOCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NOMOICOCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1507132514, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "globalnews Sept 24 2017 Dachshunds race to be top dog in Regina";
        CTransaction txNew;
        txNew.nTime = 1507132514;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507132514;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 616946 : 616946;
        ...
        assert(block.hashMerkleRoot == uint256("0xf7619fe9421863ebcdf0a683bb3e52ab77edfffd8851bf0a88f3af8d7d4c2d06"));
...
unsigned char pchMessageStart[4] = { 0xd9, 0x42, 0xc7, 0xe3 };
